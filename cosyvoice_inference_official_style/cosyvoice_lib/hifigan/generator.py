...
from ..transformer.activation import Snake # Patched
from ..utils.common import get_padding # Patched
...
class ResBlock(torch.nn.Module):
    ...
    def __init__(
        ...
        # self.convs1.apply(init_weights) # Removed
        # self.convs2.apply(init_weights) # Removed
...
class HiFTGenerator(nn.Module):
    ...
    def __init__(
        ...
        # self.ups.apply(init_weights) # Removed
        # self.conv_post.apply(init_weights) # Removed
