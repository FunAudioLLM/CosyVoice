...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  cat data/train-clean-360/parquet/data.list >> data/train.data.list
  cat data/train-other-500/parquet/data.list >> data/train.data.list
  cat data/dev-clean/parquet/data.list >> data/dev.data.list
  cat data/dev-other/parquet/data.list >> data/dev.data.list
  for model in llm; do
