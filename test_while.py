...
output_file ='./test/results/stream_go_{}_{}.wav'
...
a = open("test/logs_llm_32_cv_32_trt_2000.txt",'w+')
def text_generator():
...
for iter in range(5):
    ...
    if use_stream:
        ...
        tmp.export("test/results/stream_go_{}.wav".format(iter), format="wav")
a.close()

if DEBUG:
    tracer.stop()
    tracer.save('test/result_llm_32_trt_32_trt_2000.json')
